...
isa_t::getClass(MAYBE_UNUSED_AUTHENTICATED_PARAM bool authenticated) {
    ...
    // __has_feature 是编译器特性
    // ptrauth_calls 指的是 Pointer Authentication Codes，简称PACs.在 A12 中被引入，即从 iphone X/XR/XS 开始被引入。
...
//    取出 bits 然后使用 ISA_MASK 进行掩码处理得到 isa 真实地址；
#   else
    clsbits &= ISA_MASK;
#   endif
